...
/*   Updated: 2019/12/17 18:58:45 by psemsari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main()//int ac, char **av)
{
	...
	// ret1 = ft_printf("'%10d %-5.2s'", 42, "42 born 2 code"); printf("\n");
	// ret2 = printf("'%10d %-5.2s'", 42, "42 born 2 code"); printf("\n");
	// checkdiff(ret1, ret2);
	//
	// ret1 = ft_printf("'%-10.6d'", -42); printf("\n");
	// ret2 = printf("'%-10.6d'", -42); printf("\n");
	...
	// checkdiff(ret1, ret2);
	//
	// ret1 = ft_printf("'%-1.*s'", 0, "42 born 2 code"); printf("\n");
	// ret2 = printf("'%-1.*s'", 0, "42 born 2 code"); printf("\n");
	// checkdiff(ret1, ret2);
	//
	//
	// return (0);
